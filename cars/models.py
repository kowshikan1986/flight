...
class Car(TimeStampedModel):
	...
	default_pickup_date = models.DateField(blank=True, null=True)
	default_dropoff_date = models.DateField(blank=True, null=True)
	price_per_trip = models.DecimalField(max_digits=8, decimal_places=2)
